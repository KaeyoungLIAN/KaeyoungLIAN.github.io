    ...
    <section className="relative bg-black pt-32 md:pt-44 pb-10 md:pb-14 px-6 overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          ...
          <em className="italic text-white/60" style={{ fontFamily: "'Instrument Serif', serif" }}>ideas</em>{' '}
          <span className="font-normal">for</span>
          <br className="hidden md:block" />
          <em className="italic text-white/60" style={{ fontFamily: "'Instrument Serif', serif" }}>minds</em>{' '}
